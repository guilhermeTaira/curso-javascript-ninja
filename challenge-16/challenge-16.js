(function(){
  ...
  */
  ...
  var fullName = 'guilherme-salvioni-taira';

  var fullName1 = fullName.split('-').map(function(name){
  ...
  */
  ...
  var arrNomes = ['Guilherme','Eduardo','Rodolfo','Lee','Amanda'];

  var nomesJuntos = arrNomes.reduce(function(acumulado, atual, index){
    var separador = index < arrNomes.length - 1 ? ", " : " e ";
